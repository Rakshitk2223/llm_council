...
export function LayoutToggle() {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 left-[calc(var(--sidebar-width)+1rem)] z-40 glass-elevated px-3 py-2 rounded-full flex items-center gap-2 hover:bg-surface-elevated/50 transition-all group"
