const MONOTONIC_COLOR = { hue: 0, color: 'currentColor' };
const SENATOR_MONOTONIC = { hue: 0, color: 'currentColor' };
...
export function getMemberColor(_memberId: string): { color: string; hue: number } {
  return MONOTONIC_COLOR;
}
...
export function getMemberColorStyle(_memberId: string): {
...
export { MONOTONIC_COLOR as MEMBER_COLORS, SENATOR_MONOTONIC as SENATOR_COLOR };
